$(function () {
    ...
    $(".choose-skin li").on("click", function () {
        ...
        localStorage.setItem("skin-theme", e.data("theme"));
        $(".choose-skin li").removeClass("active"), t.removeClass("theme-" + i), e.addClass("active"), t.addClass("theme-" + e.data("theme"))
    }), setTimeout(function () {
        $(".page-loader-wrapper").fadeOut()
    }, 50), $(".sidebar").metisMenu(), $('.navbar-form.search-form input[type="text"]').on("focus", function () {
        $(this).animate({
            width: "+=50px"
        }, 300)
        ...
        $("body").hasClass("layout-fullwidth") ? $("body").removeClass("layout-fullwidth") : $("body").addClass("layout-fullwidth"), $(this).find(".fa").toggleClass("fa-angle-double-left fa-angle-double-right")
    ...
    new ApexCharts(document.querySelector("#bh_visitors"), e).render();
    e = {
        chart: {
            type: "bar",
            width: 50,
    ...
    new ApexCharts(document.querySelector("#bh_visits"), e).render();
    e = {
        chart: {
            type: "bar",
            width: 50,
    ...
    new ApexCharts(document.querySelector("#bh_chats"), e).render()
});
...
! function () {
    ...
    t.async = !0, t.charset = "UTF-8", t.setAttribute("crossorigin", "*")
}(),
    function (t, e) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).metisMenu = e(t.$)
    }(this, function (t) {
        "use strict";
        var e, n = (e = t) && "object" == typeof e && "default" in e ? e : {
            default: e
        };
        const a = (i => {
            ...
            return i.fn.mmEmulateTransitionEnd = function (t) {
                let e = !1;
        ...
        class u {
            ...
            init() {
                const o = this,
                    r = this.config,
                    t = n.default(this.element);
                t.addClass("metismenu"), t.find(`${r.parentTrigger}.${h}`).children(r.triggerElement).attr("aria-expanded", "true"), t.find(`${r.parentTrigger}.${h}`).parents(r.parentTrigger).addClass(h), t.find(`${r.parentTrigger}.${h}`).parents(r.parentTrigger).children(r.triggerElement).attr("aria-expanded", "true"), t.find(`${r.parentTrigger}.${h}`).has(r.subMenu).children(r.subMenu).addClass(`${d} ${c}`), t.find(r.parentTrigger).not(`.${h}`).has(r.subMenu).children(r.subMenu).addClass(d), t.find(r.parentTrigger).children(r.triggerElement).on(l.CLICK_DATA_API, function (t) {
                    const e = n.default(this);
                    if ("true" !== e.attr("aria-disabled")) {
                        r.preventDefault && "#" === e.attr("href") && t.preventDefault();
                        const i = e.parent(r.parentTrigger),
                            a = i.siblings(r.parentTrigger),
                            s = a.children(r.triggerElement);
                        i.hasClass(h) ? (e.attr("aria-expanded", "false"), o.removeActive(i)) : (e.attr("aria-expanded", "true"), o.setActive(i), r.toggle && (o.removeActive(a), s.attr("aria-expanded", "false"))), r.onTransitionStart && r.onTransitionStart(t)
                    }
                })
            }
            setActive(t) {
                n.default(t).addClass(h);
                const e = n.default(t).children(this.config.subMenu);
                0 < e.length && !e.hasClass(c) && this.show(e)
            }
            removeActive(t) {
                n.default(t).removeClass(h);
                t = n.default(t).children(`${this.config.subMenu}.${c}`);
                0 < t.length && this.hide(t)
            }
            show(t) {
                if (!this.transitioning && !n.default(t).hasClass(g)) {
                    const e = n.default(t),
                        i = n.default.Event(l.SHOW);
                    if (e.trigger(i), !i.isDefaultPrevented()) {
                        if (e.parent(this.config.parentTrigger).addClass(h), this.config.toggle) {
                            const t = e.parent(this.config.parentTrigger).siblings().children(`${this.config.subMenu}.${c}`);
                            this.hide(t)
                        }
                        e.removeClass(d).addClass(g).height(0), this.setTransitioning(!0), e.height(t[0].scrollHeight).one(a.TRANSITION_END, () => {
                            this.config && this.element && (e.removeClass(g).addClass(`${d} ${c}`).height(""), this.setTransitioning(!1), e.trigger(l.SHOWN))
                        }).mmEmulateTransitionEnd(350)
                    }
                }
            }
            hide(t) {
                if (!this.transitioning && n.default(t).hasClass(c)) {
                    const e = n.default(t),
                        i = n.default.Event(l.HIDE);
                    e.trigger(i), i.isDefaultPrevented() || (e.parent(this.config.parentTrigger).removeClass(h), e.height(e.height())[0].offsetHeight, e.addClass(g).removeClass(d).removeClass(c), this.setTransitioning(!0), t = () => {
                        this.config && this.element && (this.transitioning && this.config.onTransitionEnd && this.config.onTransitionEnd(), this.setTransitioning(!1), e.trigger(l.HIDDEN), e.removeClass(g).addClass(d))
                    }, 0 === e.height() || "none" === e.css("display") ? t() : e.height(0).one(a.TRANSITION_END, t).mmEmulateTransitionEnd(350))
                }
            }
            setTransitioning(t) {
            ...
            dispose() {
                n.default.removeData(this.element, s), n.default(this.element).find(this.config.parentTrigger).children(this.config.triggerElement).off(l.CLICK_DATA_API), this.transitioning = null, this.config = null, this.element = null
            }
            static jQueryInterface(a) {
                return this.each(function () {
                    ...
                    if (e || (e = new u(this, i), t.data(s, e)), "string" == typeof a) {
        ...
        return n.default.fn[i] = u.jQueryInterface, n.default.fn[i].Constructor = u, n.default.fn[i].noConflict = () => (n.default.fn[i] = o, u.jQueryInterface), u
    }),
    function (t, e) {
        ...
        var I = (o(z, [{
            ...
            C = (o(A, [{
                ...
                value: function (t, e) {
                    var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                        ...
                        e = this.w;
                    return t.unfilter(!0), I.isIE() && "radialBar" === e.config.chart.type || (r = Array.isArray(r) ? r[i] : r, t.filter(function (t) {
                        var e = I.isSafari() || I.isFirefox() || I.isIE() ? t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o) : t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o).merge(t.source);
                        t.blend(t.source, e)
            ...
            M = (o(k, [{
                ...
                value: function (t, e, i) {
                    ...
                    }), r = s) : "circle" !== i.shape && i.shape || (I.isNumber(e) || (e = o = 0), r = this.drawCircle(o, {
                        cx: t,
                        cy: e,
                        class: i.class || "",
                        stroke: i.pointStrokeColor,
            ...
            f = (o(x, [{
                ...
                value: function (t, e, i) {
                    ...
                    a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (o = p + parseFloat(t.label.style.fontSize) + t.marker.size, r = p), I.isNumber(s) && (p = {
                        pSize: t.marker.size,
        ...
        var E = {
            ...
            Y = (o(Xe, [{
                ...
                value: function (t) {
                    ...
                    }), t = I.listToArray(t), Array.prototype.forEach.call(t, function (t) {
            ...
            F = (o(Ee, [{
                ...
                value: function (t) {
                    ...
                    i.appendChild(o), o.setAttributeNS(window.SVG.xlink, "href", r), M.setAttrs(o, {
                        x: 0,
                        y: 0,
                ...
                value: function (t) {
                    ...
                    return -1 === o.indexOf("rgb") ? o.length < 9 && (l = I.hexToRgba(o, n)) : -1 < o.indexOf("rgba") && (n = I.getOpacityFromRGBA(o)), t.opacity && (n = t.opacity), "pattern" === r && (i = this.handlePatternFill(i, o, n, l)), "gradient" === r && (a = this.handleGradientFill(o, n, this.seriesIndex)), i = "image" === r ? (o = s.fill.image.src, s = t.patternID || "", this.clippedImgArea({
                        opacity: n,
                ...
                value: function (t, e, i) {
                    ...
                    return void 0 === a.fill.gradient.gradientToColors || 0 === a.fill.gradient.gradientToColors.length ? c = "dark" === a.fill.gradient.shade ? r.shadeColor(-1 * parseFloat(a.fill.gradient.shadeIntensity), -1 < t.indexOf("rgb") ? I.rgb2hex(t) : t) : r.shadeColor(parseFloat(a.fill.gradient.shadeIntensity), -1 < t.indexOf("rgb") ? I.rgb2hex(t) : t) : a.fill.gradient.gradientToColors[s.seriesNumber] ? -1 < (c = r = a.fill.gradient.gradientToColors[s.seriesNumber]).indexOf("rgba") && (e = I.getOpacityFromRGBA(r)) : c = t, a.fill.gradient.inverseColors && (t = l, l = c, c = t), -1 < l.indexOf("rgb") && (l = I.rgb2hex(l)), -1 < c.indexOf("rgb") && (c = I.rgb2hex(c)), o.drawGradient(n, l, c, h, e, s.size, a.fill.gradient.stops, a.fill.gradient.colorStops, i)
                }
            }]), Ee),
            R = (o(ze, [{
                    ...
                    if ((0 < o.globals.markers.size[e] || s) && (l = h.group({
                        ...
                        for (var c = 0; c < n.x.length; c++) {
                            var d, g = 1 === i && 1 === c ? 1 : 1 === i && 0 === c ? 0 : i,
                                u = "apexcharts-marker";
                            "line" !== o.config.chart.type && "area" !== o.config.chart.type || o.globals.comboCharts || o.config.tooltip.intersect || (u += " no-pointer-events"), (Array.isArray(o.config.markers.size) ? 0 < o.globals.markers.size[e] : 0 < o.config.markers.size) || s ? (I.isNumber(n.y[c]) ? u += " w".concat(I.randomId()) : u = "apexcharts-nullpoint", d = this.getMarkerConfig({
                                cssClass: u,
                                seriesIndex: e,
                                dataPointIndex: g
            ...
            H = (o(Ie, [{
                ...
                value: function (t, e, i) {
                    ...
                    for (var c = r.group({
                        ...
                        }, "bubble" === o.config.chart.type ? (p = u(g = o.globals.seriesZ[e][h]), l = t.y[d], l = new D(this.ctx).centerTextInBubble(l, e, h).y) : void 0 !== g && (p = u(g)), this.plotDataLabelsText({
                            x: f,
                            y: l,
                            text: p,
                            i: e,
                ...
                value: function (t, e) {
                    var i = this.w,
                        ...
                        r = e.width,
                        n = e.height,
                        i = new M(this.ctx).drawRect(e.x - s, e.y - o / 2, r + 2 * s, n + o, a.borderRadius, "transparent" === i.config.chart.background ? "#fff" : i.config.chart.background, a.opacity, a.borderWidth, a.borderColor);
            ...
            O = (o(Pe, [{
                ...
                key: "getSeriesByName",
                value: function (t) {
                    return this.w.globals.dom.baseEl.querySelector(".apexcharts-inner .apexcharts-series[seriesName='".concat(I.escapeString(t), "']"))
                }
            }, {
                key: "isSeriesHidden",
                value: function (t) {
            ...
            V = (o(Se, [{
                ...
                value: function (t, e) {
                    var i = 30;
                    return t = I.monthMod(t), !0 == -1 < this.months30.indexOf(t) ? 2 === t && (i = this.isLeapYear(e) ? 29 : 28) : (this.months31.indexOf(t), i = 31), i
                }
            }]), Se),
            G = function () {
                n(e, B);
            ...
            j = (o(ke, [{
                ...
                value: function (i, t) {
                    var a = new X;
                    (void 0 === i.yaxis || !i.yaxis || Array.isArray(i.yaxis) && 0 === i.yaxis.length) && (i.yaxis = {}), i.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (i.yaxis = I.extend(i.yaxis, window.Apex.yaxis)), i.yaxis.constructor !== Array ? i.yaxis = [I.extend(a.yAxis, i.yaxis)] : i.yaxis = I.extendArray(i.yaxis, a.yAxis);
                    var e = !1;
            ...
            U = (o(we, [{
                ...
                value: function (t) {
                    ...
                    return this.initGlobalVars(e), e.initialConfig = I.extend({}, t), e.initialSeries = I.clone(t.series), e.lastXAxis = I.clone(e.initialConfig.xaxis), e.lastYAxis = I.clone(e.initialConfig.yaxis), e
                }
            }]), we),
            q = (o(ye, [{
                key: "init",
            ...
            Z = (o(ve, [{
                ...
                value: function (t, e) {
                    ...
                    for (var r = 0; r < t[e].data.length; r++) void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) ? this.twoDSeries.push(I.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1])) : this.twoDSeries.push(I.parseNumber(t[e].data[r].y))), void 0 !== t[e].data[r].goals && Array.isArray(t[e].data[r].goals) ? (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(t[e].data[r].goals)) : (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(null));
            ...
            $ = (o(me, [{
                ...
                value: function (t, e, i) {
                    var a = this.w;
                    return t = I.isNumber(t) ? 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0) : t
                }
            }, {
                ...
                value: function () {
                    ...
                    return s.globals.xaxisTooltipFormatter = function (t) {
                        ...
                        if (I.isNumber(t)) {
                            ...
                            if (I.isNumber(s.config.xaxis.decimalsInFloat)) return t.toFixed(s.config.xaxis.decimalsInFloat);
            ...
            Q = (o(be, [{
                ...
                value: function (t, e, i, a) {
                    ...
                    a = new M(this.ctx), c = {}, c = r.globals.rotateXLabels ? a.getTextRects(l, parseInt(o, 10), null, "rotate(".concat(r.config.xaxis.labels.rotate, " 0 0)"), !1) : a.getTextRects(l, parseInt(o, 10)), r = !r.config.xaxis.labels.showDuplicates && this.ctx.timeScale;
                    return {
                        x: i,
            ...
            J = (o(xe, [{
                ...
                value: function (n) {
                    ...
                    return new Promise(function (e) {
                        ...
                        window.canvg && I.isIE11() ? ((s = window.canvg.Canvg.fromString(o, t, {
                            ignoreClear: !0,
                            ignoreDimensions: !0
                            ...
                            if (g.length && 0 === e && u.push(g.join(c)), t.data && t.data.length)
                                for (var i = 0; i < t.data.length; i++) {
                                    ...
                                    s = (s = i, r = o = void 0, n = "", d.globals.axisCharts ? ("category" !== d.config.xaxis.type && !d.config.xaxis.convertedCatToNumeric || (n = d.globals.isBarHorizontal ? (o = d.globals.yLabelFormatters[0], r = new O(l.ctx).getActiveConfigSeriesIndex(), o(d.globals.labels[s], {
                                        ...
                                        dataPointIndex: s,
                                        w: d
                                    })) : f.getLabel(d.globals.labels, d.globals.timescaleLabels, 0, s).text), "datetime" === d.config.xaxis.type && (d.config.xaxis.categories.length ? n = d.config.xaxis.categories[s] : d.config.labels.length && (n = d.config.labels[s]))) : n = d.config.labels[s], Array.isArray(n) && (n = n.join(" ")), I.isNumber(n) ? n : n.split(c).join(""));
                                    if (s || (p.isFormatXY() ? s = h[e].data[i].x : p.isFormat2DArray() && (s = h[e].data[i] ? h[e].data[i][0] : "")), 0 === e) {
                                        g.push((n = s, "datetime" === d.config.xaxis.type && 10 <= String(n).length ? d.config.chart.toolbar.export.csv.dateFormatter(s) : I.isNumber(s) ? s : s.split(c).join("")));
            ...
            K = (o(fe, [{
                ...
                value: function (t, e) {
                    var i, a, s = this.w,
                        o = t;
                    t < 0 || t - 2 > s.globals.gridWidth || (a = (i = this.offY + s.config.xaxis.axisTicks.offsetY) + s.config.xaxis.axisTicks.height, "top" === s.config.xaxis.position && (a = i - s.config.xaxis.axisTicks.height), s.config.xaxis.axisTicks.show && (s = new M(this.ctx).drawLine(t + s.config.xaxis.axisTicks.offsetX, i + s.config.xaxis.offsetY, o + s.config.xaxis.axisTicks.offsetX, a + s.config.xaxis.offsetY, s.config.xaxis.axisTicks.color), e.add(s), s.node.classList.add("apexcharts-xaxis-tick")))
                }
            }, {
            ...
            tt = (o(pe, [{
                ...
                value: function (t) {
                    var e = t.x1,
                        ...
                        l = new M(this).drawLine(e - (n ? t : 0), i, a + (n ? t : 0), s, r.config.grid.borderColor, l);
            ...
            et = (o(ue, [{
                ...
                value: function (t, e) {
                    var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                        ...
                        o = this.w,
                        r = Math.abs(e - t);
                    if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, r)) && (i = o.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !I.isNumber(t) && !I.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) return e = i, this.linearScale(t = 0, e, i);
                ...
                value: function (t, e, i) {
                    var a = t;
                    return void 0 !== e && this.w.config.yaxis[e].labels.formatter && void 0 === this.w.config.yaxis[e].tickAmount && (e = this.w.config.yaxis[e].labels.formatter(1), I.isNumber(Number(e)) && !I.isFloat(e) && (a = Math.ceil(i))), a < t ? a : t
                }
            }, {
                ...
                value: function (t, e, i) {
                    ...
                    var r = Math.abs(i - e);
                    o.logarithmic && r <= 5 && (a.invalidLogScale = !0), o.logarithmic && 5 < r ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i, o.logBase)) : i !== -Number.MAX_VALUE && I.isNumber(i) ? (a.allSeriesCollapsed = !1, void 0 === o.min && void 0 === o.max || o.forceNiceScale ? (s = void 0 === s.yaxis[t].max && void 0 === s.yaxis[t].min || s.yaxis[t].forceNiceScale, a.yAxisScale[t] = this.niceScale(e, i, o.tickAmount || (r < 5 && 1 < r ? r + 1 : 5), t, s)) : a.yAxisScale[t] = this.linearScale(e, i, o.tickAmount, t)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
                }
            }, {
                key: "setXScale",
                value: function (t, e) {
                    var i = this.w,
                        ...
                        s = i.config.xaxis,
                        i = Math.abs(e - t);
                    return e !== -Number.MAX_VALUE && I.isNumber(e) ? a.xAxisScale = this.linearScale(t, e, s.tickAmount || (i < 5 && 1 < i ? i + 1 : 5), 0) : a.xAxisScale = this.linearScale(0, 5, 5), a.xAxisScale
                }
            }, {
                ...
                value: function () {
                    ...
                    if (t.series.length)
                        for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                            for (var s = 0, o = 0, r = 0; r < t.series.length; r++) null !== t.series[r][a] && I.isNumber(t.series[r][a]) && (0 < t.series[r][a] ? s = s + parseFloat(t.series[r][a]) + 1e-4 : o += parseFloat(t.series[r][a])), r === t.series.length - 1 && (e.push(s), i.push(o));
            ...
            at = (o(de, [{
                ...
                value: function () {
                    ...
                    (t = I.listToArray(t)).forEach(function (t, e) {
                        ...
                        s && void 0 !== s.labels.align && (i = o.globals.dom.baseEl.querySelector(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-texts-g")), a = o.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-label")), a = I.listToArray(a), e = i.getBoundingClientRect(), "left" === s.labels.align ? (a.forEach(function (t, e) {
            ...
            rt = (o(ne, [{
                ...
                value: function () {
                    ...
                    t.config.xaxis.crosshairs.show && ("gradient" === o && (s = e.drawGradient("vertical", r, n, l, h, null, c, null)), h = e.drawRect(), 1 === t.config.xaxis.crosshairs.width && (h = e.drawLine()), c = t.globals.gridHeight, (!I.isNumber(c) || c < 0) && (c = 0), e = t.config.xaxis.crosshairs.width, (!I.isNumber(e) || e < 0) && (e = 0), h.attr({
            ...
            nt = (o(re, [{
                ...
                value: function (t) {
                    ...
                    0 !== i.responsive.length && ((s = i.responsive.slice()).sort(function (t, e) {
                        ...
                        if (e < i) {
                            e = P.extendArrayProps(o, n.globals.initialConfig, n), t = I.extend(e, t);
                            t = I.extend(n.config, t), r.overrideResponsiveOptions(t)
                        } else
                            for (var a = 0; a < s.length; a++) i < s[a].breakpoint && (t = P.extendArrayProps(o, s[a].options, n), t = I.extend(n.config, t), r.overrideResponsiveOptions(t))
                    }, t ? (i = P.extendArrayProps(o, t, n), i = I.extend(n.config, i), e(i = I.extend(i, t))) : e({}))
                }
            }, {
            ...
            ht = (o(se, [{
                ...
                value: function (t) {
                    var e = this.w,
                        ...
                        s = i.offsetY,
                        o = "middle";
                    "left" === i.align ? (a = 10, o = "start") : "right" === i.align && (a = e.globals.svgWidth - 10, o = "end"), a += i.offsetX, s = s + parseInt(i.style.fontSize, 10) + i.margin / 2, void 0 !== i.text && ((i = new M(this.ctx).drawText({
                        x: a,
                        y: s,
                        text: i.text,
                        textAnchor: o,
            ...
            ct = (o(ae, [{
                ...
                value: function () {
                    ...
                    var i = Object.assign({}, I.getBoundingClientRect(e));
            ...
            dt = (o(ie, [{
                ...
                value: function () {
                    ...
                    return n.config.xaxis.convertedCatToNumeric && 0 === l.length && (l = n.globals.categoryLabels), 0 < n.globals.timescaleLabels.length ? (t = {
                        ...
                        dateFormatter: new V(this.dCtx.ctx).formatDate,
                        w: n
                    }), (n.config.xaxis.convertedCatToNumeric && void 0 === i || "" === String(i).trim()) && (a = i = "1"), o = r = (s = new M(this.dCtx.ctx)).getTextRects(i, n.config.xaxis.labels.style.fontSize), i !== a && (o = s.getTextRects(a, n.config.xaxis.labels.style.fontSize)), (t = {
                ...
                value: function () {
                    var t = this.w,
                        e = 0,
                        i = 0;
                    return void 0 !== t.config.xaxis.title.text && (e = (t = new M(this.dCtx.ctx).getTextRects(t.config.xaxis.title.text, t.config.xaxis.title.style.fontSize)).width, i = t.height), {
                        width: e,
                        height: i
                    }
                }
            ...
            gt = (o(ee, [{
                ...
                value: function () {
                    ...
                    return h.config.yaxis.map(function (t, e) {
                        ...
                        !g.isYAxisHidden(e) && t.labels.show && void 0 !== t.labels.minWidth && (n = t.labels.minWidth), !g.isYAxisHidden(e) && t.labels.show && r.result.length ? (s = h.globals.yLabelFormatters[e], i = r.niceMin === Number.MIN_VALUE ? 0 : r.niceMin, void 0 !== (r = i = s(a = String(i).length > String(r.niceMax).length ? i : r.niceMax, {
                            ...
                            dataPointIndex: -1,
                            w: h
                        })) && 0 !== i.length || (i = a), h.globals.isBarHorizontal && (d = 0, o = h.globals.labels.slice(), i = s(i = I.getLargestStringFromArr(o), {
                            seriesIndex: e,
                            dataPointIndex: -1,
                            w: h
                        }), r = l.dCtx.dimHelpers.getLargestStringFromMultiArr(i, o)), a = new M(l.dCtx.ctx), s = "rotate(".concat(t.labels.rotate, " 0 0)"), o = e = a.getTextRects(i, t.labels.style.fontSize, t.labels.style.fontFamily, s, !1), i !== r && (o = a.getTextRects(r, t.labels.style.fontSize, t.labels.style.fontFamily, s, !1)), c.push({
                ...
                value: function () {
                    ...
                    return t.config.yaxis.map(function (t, e) {
                        var i, a;
                        t.show && void 0 !== t.title.text ? (i = new M(s.dCtx.ctx), a = "rotate(".concat(t.title.rotate, " 0 0)"), a = i.getTextRects(t.title.text, t.title.style.fontSize, t.title.style.fontFamily, a, !1), o.push({
                            width: a.width,
                            height: a.height
                        })) : o.push({
                            width: 0,
            ...
            ft = (o(Jt, [{
                ...
                value: function (t, e) {
                    ...
                    o.globals.axisCharts || "radialBar" === o.config.chart.type ? (o.globals.resized = !0, i = a = null, o.globals.risingSeries = [], i = o.globals.axisCharts ? (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")), parseInt(a.getAttribute("data:realIndex"), 10)) : (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")), parseInt(a.getAttribute("rel"), 10) - 1), e ? [{
                        ...
                        seriesEl: a,
                        realIndex: i
                    })) : (a = o.globals.dom.Paper.select(" .apexcharts-series[rel='".concat(t + 1, "'] path")), "pie" !== (t = o.config.chart.type) && "polarArea" !== t && "donut" !== t || (o = o.config.plotOptions.pie.donut.labels, new M(this.lgCtx.ctx).pathMouseDown(a.members[0], null), this.lgCtx.ctx.pie.printDataLabelsInner(a.members[0].node, o)), a.fire("click"))
                }
            }, {
                key: "hideSeries",
                value: function (t) {
            ...
            xt = (o(Qt, [{
                ...
                value: function () {
                    ...
                    if ((t.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || 1 < e.series.length || !e.axisCharts) && t.legend.show) {
                        ...
                        this.drawLegends(), I.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), "bottom" === t.legend.position || "top" === t.legend.position ? this.legendAlignHorizontal() : "right" !== t.legend.position && "left" !== t.legend.position || this.legendAlignVertical()
                    }
                }
            }, {
                key: "drawLegends",
                value: function () {
                    ...
                    for (var o = e.globals.legendFormatter, r = e.config.legend.inverseOrder, n = r ? a.length - 1 : 0; r ? 0 <= n : n <= a.length - 1; r ? n-- : n++) {
                        ...
                        var p = e.config.legend.markers.offsetX,
                            ...
                            w = u.style;
                        w.background = s[n], w.color = s[n], w.setProperty("background", s[n], "important"), e.config.legend.markers.fillColors && e.config.legend.markers.fillColors[n] && (w.background = e.config.legend.markers.fillColors[n]), void 0 !== e.globals.seriesColors[n] && (w.background = e.globals.seriesColors[n], w.color = e.globals.seriesColors[n]), w.height = Array.isArray(x) ? parseFloat(x[n]) + "px" : parseFloat(x) + "px", w.width = Array.isArray(b) ? parseFloat(b[n]) + "px" : parseFloat(b) + "px", w.left = (Array.isArray(p) ? parseFloat(p[n]) : parseFloat(p)) + "px", w.top = (Array.isArray(f) ? parseFloat(f[n]) : parseFloat(f)) + "px", w.borderWidth = Array.isArray(m) ? m[n] : m, w.borderColor = Array.isArray(v) ? v[n] : v, w.borderRadius = Array.isArray(y) ? parseFloat(y[n]) + "px" : parseFloat(y) + "px", e.config.legend.markers.customHTML && (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[n] && (u.innerHTML = e.config.legend.markers.customHTML[n]()) : u.innerHTML = e.config.legend.markers.customHTML()), M.setAttrs(u, {
                            rel: n + 1,
                            "data:collapsed": h || c
                        ...
                        w.style.color = y, w.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", w.style.fontWeight = e.config.legend.fontWeight, w.style.fontFamily = i || e.config.chart.fontFamily, M.setAttrs(w, {
                            rel: n + 1,
                            i: n,
            ...
            bt = (o($t, [{
                ...
                value: function (t, e) {
                    ...
                    }, t = I.clone(a.globals.initialConfig.yaxis), a.config.chart.zoom.autoScaleYaxis && (t = new et(this.ctx).autoScaleY(this.ctx, t, {
                        xaxis: i
            ...
            mt = function () {
                ...
                function a(t) {
                    var e;
                    return s(this, a), (e = i.call(this, t)).ctx = t, e.w = t.w, e.dragged = !1, e.graphics = new M(e.ctx), e.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], e.clientX = 0, e.clientY = 0, e.startX = 0, e.endX = 0, e.dragX = 0, e.startY = 0, e.endY = 0, e.dragY = 0, e.moveDirection = "none", e
                }
                return o(a, [{
                    key: "init",
                    value: function (t) {
                    ...
                    value: function (t) {
                        ...
                        }), M.setAttrs(l.node, r)), n.globals.selectionEnabled && (t.attr({
                            x: e,
                            y: i,
                            width: 0 < a ? a : 0,
                            height: 0 < s ? s : 0,
                    ...
                    value: function (t) {
                        ...
                        a.config.yaxis.forEach(function (t, e) {
                        ...
                        }), s.dragged && (10 < s.dragX || 10 < s.dragY) && e !== c && (a.globals.zoomEnabled ? (n = I.clone(a.globals.initialConfig.yaxis), r = I.clone(a.globals.initialConfig.xaxis), a.globals.zoomed = !0, a.config.xaxis.convertedCatToNumeric && (e = Math.floor(e), c = Math.floor(c), e < 1 && (e = 1, c = a.globals.dataPoints), c - e < 2 && (c = e + 1)), "xy" !== i && "x" !== i || (r = {
                            min: e,
                            max: c
                            ...
                            min: e,
                            max: c
                        }, "xy" !== i && "y" !== i || (h = I.clone(a.config.yaxis)).forEach(function (t, e) {
            ...
            vt = (o(Zt, [{
                ...
                value: function (t) {
                    var e = t.hoverArea,
                        ...
                        n = r.width,
                        l = r.height,
                        h = n / (o.globals.dataPoints - 1),
                        c = l / o.globals.dataPoints,
                        t = this.hasBars();
            ...
            kt = (o(jt, [{
                ...
                value: function () {
                    for (var t = this.w.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), e = 0; e < t.length; e++) {
                        ...
                        I.isNumber(i) && 0 <= i ? t[e].setAttribute("r", i) : t[e].setAttribute("r", 0)
                    }
                }
            }]), jt),
            At = (o(_t, [{
                ...
                value: function (t) {
                    var e, i, a, s, o, r = t.e,
                        ...
                        c = this.w,
                        d = this.ttCtx;
                    return r.target.classList.contains("apexcharts-marker") && (o = parseInt(n.paths.getAttribute("cx"), 10), e = parseInt(n.paths.getAttribute("cy"), 10), i = parseFloat(n.paths.getAttribute("val")), s = parseInt(n.paths.getAttribute("rel"), 10), t = parseInt(n.paths.parentNode.parentNode.parentNode.getAttribute("rel"), 10) - 1, d.intersect && (a = I.findAncestor(n.paths, "apexcharts-series")) && (t = parseInt(a.getAttribute("data:realIndex"), 10)), d.tooltipLabels.drawSeriesTexts({
                        ttItems: n.ttItems,
                        i: t,
                        j: s,
            ...
            Ct = (o(Vt, [{
                ...
                value: function (t, e, i, a) {
                    var s = this.w,
                        ...
                        r = o.j,
                        e = o.capturedSeries,
                        i = a.elGrid.getBoundingClientRect();
            ...
            Lt = function () {
                ...
                return o(e, [{
                    ...
                    value: function (m, v) {
                        var y = this,
                            w = this.w;
                        this.graphics = new M(this.ctx), this.bar = new B(this.ctx, this.xyRatios);
                        ...
                        for (var k = this.graphics.group({
                            ...
                            var h = y.graphics.group({
                                class: "apexcharts-series",
                                seriesName: I.escapeString(w.globals.seriesNames[l]),
                                rel: t + 1,
                                "data:realIndex": l
                            });
                    ...
                    value: function (x, s) {
                        ...
                        for (var y = o.group({
                            ...
                            var n = void 0,
                                ...
                                c = o.group({
                                    class: "apexcharts-series",
                                    seriesName: I.escapeString(m.globals.seriesNames[h]),
                                    rel: r + 1,
                                    "data:realIndex": h
                                });
            ...
            Tt = (o(Bt, [{
                ...
                value: function (t, e, i, a) {
                    ...
                    a = i.color, r = new I;
                    return {
                        color: a = s.config.plotOptions[t].enableShades ? "dark" === this.w.config.theme.mode ? I.hexToRgba(r.shadeColor(-1 * o, i.color), s.config.fill.opacity) : I.hexToRgba(r.shadeColor(o, i.color), s.config.fill.opacity) : a,
                        colorProps: i
                    }
                }
            }, {
                    ...
                    for (var h = n ? 0 : l.length - 1; n ? h < l.length : 0 <= h; n ? h++ : h--) {
                        ...
                        for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                            ...
                            f.attr({
                                ...
                                color: x
                            }), this.helpers.addListeners(f), e.config.chart.animations.enabled && !e.globals.dataChanged && (m = 1, e.globals.resized || (m = e.config.chart.animations.speed), this.animateHeatMap(f, g, r, s, o, m)), e.globals.dataChanged && (v = 1, this.dynamicAnim.enabled && e.globals.shouldAnimate && (v = this.dynamicAnim.speed, m = e.globals.previousPaths[h] && e.globals.previousPaths[h][p] && e.globals.previousPaths[h][p].color || "rgba(255, 255, 255, 0)", this.animateHeatColor(f, I.isColorHex(m) ? m : I.rgb2hex(m), I.isColorHex(x) ? x : I.rgb2hex(x), v)));
            ...
            zt = (o(Nt, [{
                ...
                value: function (t) {
                    ...
                    for (var s = 0, o = 0; o < t.length; o++) s += I.negToZero(t[o]);
                    var r = [],
                        n = a.group();
                ...
                value: function (t, e) {
                    ...
                    for (var c = 0; c < t.length; c++) {
                        var d = o.group({
                            ...
                            seriesName: I.escapeString(a.globals.seriesNames[c]),
                            rel: c + 1,
                            "data:realIndex": c
                        });
                        n.add(d);
                        ...
                        f.attr({
                            index: 0,
                            j: c
                        }), s.setSelectionFilter(f, 0, c), a.config.chart.dropShadow.enabled && (x = a.config.chart.dropShadow, s.dropShadow(f, x, c)), this.addListeners(f, this.donutDataLabels), M.setAttrs(f.node, {
                            "data:angle": u,
                            "data:startAngle": i,
                        ...
                        "pie" === this.chartType || "polarArea" === this.chartType ? p = I.polarToCartesian(this.centerX, this.centerY, a.globals.radialSize / 1.25 + a.config.plotOptions.pie.dataLabels.offset, (i + u / 2) % this.fullAngle) : "donut" === this.chartType && (p = I.polarToCartesian(this.centerX, this.centerY, (a.globals.radialSize + this.donutSize) / 2 + a.config.plotOptions.pie.dataLabels.offset, (i + u / 2) % this.fullAngle)), d.add(f);
                        var x = 0;
                ...
                value: function (t) {
                    ...
                    var l = Math.PI * (n - 90) / 180,
                        ...
                        n = I.polarToCartesian(e.centerX, e.centerY, e.donutSize, n),
                        o = I.polarToCartesian(e.centerX, e.centerY, e.donutSize, o),
                        a = 180 < a ? 1 : 0,
                ...
                value: function (i) {
                    ...
                    if (0 !== o.strokeWidth) {
                        for (var e = [], r = 360 / t.globals.series.length, n = 0; n < t.globals.series.length; n++) e.push(I.polarToCartesian(this.centerX, this.centerY, t.globals.radialSize, t.config.plotOptions.pie.startAngle + r * n));
            ...
            Et = (o(Ht, [{
                    ...
                    return this.yaxisLabels = this.graphics.group({
                        ...
                        var e = t.length === g.globals.dataPoints,
                            o = d.graphics.group().attr({
                                ...
                                seriesName: I.escapeString(g.globals.seriesNames[s]),
                                rel: s + 1,
                                "data:realIndex": s
                            });
                ...
                key: "drawPolygons",
                value: function (t) {
                    for (var o = this, s = this.w, r = t.parent, i = new Mt(this.ctx), a = s.globals.yAxisScale[0].result.reverse(), e = a.length, n = [], l = this.size / (e - 1), h = 0; h < e; h++) n[h] = l * h;
                    n.reverse();
                    var c = [],
                        d = [];
                    n.forEach(function (t, a) {
                        var t = I.getPolygonPos(t, o.dataPointsLen),
                            s = "";
                        t.forEach(function (t, e) {
                            var i;
                ...
                value: function () {
                    var o = this,
                        ...
                        h = I.getPolygonPos(this.size, this.dataPointsLen);
                    ...
                    value: function (t) {
                        ...
                        for (var d = !1, g = (d = e.config.plotOptions.radialBar.inverseOrder ? !0 : d) ? t.series.length - 1 : 0; d ? 0 <= g : g < t.series.length; d ? g-- : g++) {
                            var u = i.group({
                                ...
                                seriesName: I.escapeString(e.globals.seriesNames[g])
                            });
                            o.add(u), u.attr({
                                rel: g + 1,
                                "data:realIndex": g
                            ...
                            var p = a.fillPath({
                                ...
                                f = this.startAngle,
                                x = void 0,
                                b = I.negToZero(100 < t.series[g] ? 100 : t.series[g]) / 100,
                                m = Math.round(this.totalAngle * b) + this.startAngle,
                                v = void 0;
                            e.globals.dataChanged && (x = this.startAngle, v = Math.round(this.totalAngle * I.negToZero(e.globals.previousPaths[g]) / 100) + x), 360 <= Math.abs(m) + Math.abs(f) && (m -= .01), 360 <= Math.abs(v) + Math.abs(x) && (v -= .01);
                            var y = m - f,
            ...
            Ft = (o(Rt, [{
                ...
                value: function (t) {
                    for (var e, i = t.series, a = t.realIndex, s = t.i, o = t.x, r = (t.y, t.pX), n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new M(this.ctx), b = this.yRatio, m = l.prevY, v = l.linePath, y = l.areaPath, w = l.pathFromLine, k = l.pathFromArea, A = I.isNumber(f.globals.minYArr[a]) ? f.globals.minYArr[a] : f.globals.minY, S = 1 < f.globals.dataPoints ? f.globals.dataPoints - 1 : f.globals.dataPoints, C = 0; C < S; C++) {
        ...
        function Qt(t, e) {
            s(this, Qt), this.ctx = t, this.w = t.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length, this.legendHelpers = new ft(this)
        }

        function Jt(t) {
            s(this, Jt), this.w = t.w, this.lgCtx = t
        }
        ...
        function ce(t) {
            s(this, ce), this.ctx = t, this.w = t.w, this.documentEvent = I.bind(this.documentEvent, this)
        }
        ...
        function pe(t) {
            ...
            var e = this.w;
            this.xaxisLabels = e.globals.labels.slice(), this.axesUtils = new Q(t), this.isRangeBar = e.globals.seriesRangeBar.length, 0 < e.globals.timescaleLabels.length && (this.xaxisLabels = e.globals.timescaleLabels.slice())
        }

        function fe(t) {
            s(this, fe), this.ctx = t, this.w = t.w;
            var e = this.w;
            this.axesUtils = new Q(t), this.xaxisLabels = e.globals.labels.slice(), 0 < e.globals.timescaleLabels.length && !e.globals.isBarHorizontal && (this.xaxisLabels = e.globals.timescaleLabels.slice()), e.config.xaxis.overwriteCategories && (this.xaxisLabels = e.config.xaxis.overwriteCategories), this.drawnLabels = [], this.drawnLabelsRects = [], "top" === e.config.xaxis.position ? this.offY = 0 : this.offY = e.globals.gridHeight + 1, this.offY = this.offY + e.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = "bar" === e.config.chart.type && e.config.plotOptions.bar.horizontal, this.xaxisFontSize = e.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = e.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = e.config.xaxis.labels.style.colors, this.xaxisBorderWidth = e.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = e.config.yaxis[0].axisBorder.width.toString()), -1 < this.xaxisBorderWidth.indexOf("%") ? this.xaxisBorderWidth = e.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = e.config.xaxis.axisBorder.height, this.yaxis = e.config.yaxis[0]
        }
        ...
        function Ie(t) {
            s(this, Ie), this.ctx = t, this.w = t.w
        }

        function Me(t) {
            s(this, Me), this.ctx = t, this.w = t.w, this.initialAnim = this.w.config.chart.animations.enabled, this.dynamicAnim = this.initialAnim && this.w.config.chart.animations.dynamicAnimation.enabled
        }
        ...
        var Oe, We, Be, Ve, Ge, _e, je = (o(Ke, [{
            ...
            value: function (p) {
                ...
                return p.forEach(function (t) {
                    ...
                    var u = b.group({
                        ...
                        seriesName: I.escapeString(x.globals.seriesNames[g]),
                        rel: g + 1,
                        "data:realIndex": g
                    });
            ...
            Ue = (o(Je, [{
                ...
                value: function (t) {
                    var e = t.firstVal,
                        ...
                        c = "month",
                        d = 0;
                    1 < e.minDate ? (l = (h.determineDaysOfMonths(a + 1, e.minYear) - i + 1) * o, n = I.monthMod(a + 1), t = s + d, e = I.monthMod(n), 0 === (i = n) && (c = "year", i = t, t += d += e = 1), this.timeScaleArray.push({
                        position: l,
                        value: i,
                        unit: c,
                        year: t,
                    ...
                    for (var g = n + 1, u = l, p = 0; p < r; p++, 0) {
                        0 === (g = I.monthMod(g)) ? (c = "year", d += 1) : c = "month";
                ...
                value: function (t) {
                    ...
                    var i = t.firstVal,
                        ...
                        d = h,
                        g = e(c, a, s);
                    0 === i.minHour && 1 === i.minDate ? (t = 0, d = I.monthMod(i.minMonth), l = "month", c = i.minDate, r++) : 1 !== i.minDate && 0 === i.minHour && 0 === i.minMinute && (t = 0, h = i.minDate, g = e(c = d = h, a, s)), this.timeScaleArray.push({
                        position: t,
                        value: d,
                        unit: l,
            ...
            qe = (o(Qe, [{
                ...
                value: function (a, t) {
                    ...
                    if (r.comboCharts) 0 < l.series.length && m.push(e.draw(l.series, "area", l.i)), 0 < d.series.length && (s.config.chart.stacked ? (f = new Lt(this.ctx, t), m.push(f.draw(d.series, d.i))) : (this.ctx.bar = new B(this.ctx, t), m.push(this.ctx.bar.draw(d.series, d.i)))), 0 < n.series.length && m.push(e.draw(n.series, "line", n.i)), 0 < g.series.length && m.push(i.draw(g.series, g.i)), 0 < u.series.length && m.push(i.draw(u.series, u.i)), 0 < h.series.length && (x = new Ft(this.ctx, t, !0), m.push(x.draw(h.series, "scatter", h.i))), 0 < c.series.length && (x = new Ft(this.ctx, t, !0), m.push(x.draw(c.series, "bubble", c.i)));
                        ...
                        case "rangeBar":
                            ...
                            break;
                        case "heatmap":
                            m = new It(this.ctx, t).draw(r.series);
                            break;
                        case "treemap":
                ...
                value: function () {
                    ...
                    var i = I.getDimensions(this.el),
                        a = e.chart.width.toString().split(/[0-9]+/g).pop();
                    "%" === a ? I.isNumber(i[0]) && (0 === i[0].width && (i = I.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width, 10) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width, 10));
                    i = e.chart.height.toString().split(/[0-9]+/g).pop();
                    "auto" !== t.svgHeight && "" !== t.svgHeight ? "%" === i ? (a = I.getDimensions(this.el.parentNode), t.svgHeight = a[1] * parseInt(e.chart.height, 10) / 100) : t.svgHeight = parseInt(e.chart.height, 10) : t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth / 1.2, t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), M.setAttrs(t.dom.Paper.node, {
                        width: t.svgWidth,
                        height: t.svgHeight
                ...
                value: function () {
                    ...
                    s && !t.config.chart.sparkline.enabled && (o = (s = I.getBoundingClientRect(s)).bottom, s = s.bottom - s.top, o = Math.max(2.05 * t.globals.radialSize, s));
                    a = o + e.translateY + i + a;
                    e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", a), e.dom.elWrap.style.height = a + "px", M.setAttrs(e.dom.Paper.node, {
                        height: a
            ...
            Ze = (o($e, [{
                ...
                value: function (t, e) {
                    ...
                    return s.globals.shouldAnimate = e, s.globals.dataChanged = !0, e && this.ctx.series.getPreviousPaths(), s.globals.axisCharts ? (0 === (e = t.map(function (t, e) {
                        ...
                        data: []
                    }]), s.config.series = e) : s.config.series = t.slice(), a && (s.globals.initialSeries = I.clone(s.config.series)), this.ctx.update()
                }
            }, {
                key: "_extendSeries",
                value: function (t, e) {
                ...
                value: function (t, e) {
                    ...
                    return i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], "pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type || this.ctx.pie.pieClicked(t)), a ? (new M(this.ctx).pathMouseDown(a, null), a.node || null) : (console.warn("toggleDataPointSelection: Element not found"), null)
                }
            }, {
        ...
        function Qe(t, e) {
            s(this, Qe), this.ctx = e, this.w = e.w, this.el = t
        }

        function Je(t) {
            s(this, Je), this.ctx = t, this.w = t.w, this.timeScaleArray = [], this.utc = this.w.config.xaxis.labels.datetimeUTC
        }
        ...
        var oi = (o(li, [{
            key: "initModules",
            value: function () {
                this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new S(this.ctx), this.ctx.axes = new ot(this.ctx), this.ctx.core = new qe(this.ctx.el, this.ctx), this.ctx.config = new j({}), this.ctx.data = new Z(this.ctx), this.ctx.grid = new tt(this.ctx), this.ctx.graphics = new M(this.ctx), this.ctx.coreUtils = new P(this.ctx), this.ctx.crosshairs = new rt(this.ctx), this.ctx.events = new t(this.ctx), this.ctx.exports = new J(this.ctx), this.ctx.localization = new st(this.ctx), this.ctx.options = new X, this.ctx.responsive = new nt(this.ctx), this.ctx.series = new O(this.ctx), this.ctx.theme = new lt(this.ctx), this.ctx.formatters = new $(this.ctx), this.ctx.titleSubtitle = new ht(this.ctx), this.ctx.legend = new xt(this.ctx), this.ctx.toolbar = new bt(this.ctx), this.ctx.dimensions = new pt(this.ctx), this.ctx.updateHelpers = new Ze(this.ctx), this.ctx.zoomPanSelection = new mt(this.ctx), this.ctx.w.globals.tooltip = new Ct(this.ctx)
            }
        }]), li),
            ri = (o(ni, [{
                key: "clear",
        ...
        return o(hi, [{
            ...
            value: function () {
                ...
                i && Apex._chartInstances.forEach(function (t, e) {
                    t.id === I.escapeString(i) && Apex._chartInstances.splice(e, 1)
